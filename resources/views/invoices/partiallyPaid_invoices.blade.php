    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/قائمة الفواتير المدفوعة جزئياً
                </span>
            </div>
        </div>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a href="{{ url('invoices/'.$invoice->id) }}" class="dropdown-item">
                                                    ...
                                                    <a href="#" data-invoice_id="{{ $invoice->id }}"
                                                        class="text-danger dropdown-item" data-toggle="modal"
