            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        {{-- enctype attribute  due to file upload --}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Amount_Commission"
                                    ...
                                    required value="{{old('Amount_Commission')}}">
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Discount" name="Discount"
                                    ...
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    value=0 required value="{{old('Discount')}}">
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="Value_VAT" value="{{old('Value_VAT')}}" name="Value_VAT" readonly>
                            </div>
