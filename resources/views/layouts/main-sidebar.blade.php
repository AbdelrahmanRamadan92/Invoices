			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						...
						<div class="user-info">
							<h4 class="font-weight-semibold mt-3 mb-0">{{Auth::user() ? Auth::user()->name : 'guest'}}</h4>
							<span class="mb-0 text-muted">{{Auth::user() ? Auth::user()->email : ''}}</span>
						</div>
					</div>
				</div>
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='pay/1') }}">الفواتير المدفوعة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='pay/2') }}">الفواتير الغير مدفوعة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='pay/3') }}">الفواتير المدفوعة جزئياً</a></li>
