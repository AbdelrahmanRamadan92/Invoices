                        ...
                        <table class="table text-md-nowrap key-buttons" id="example1" data-page-length="50">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-20p border-bottom-0">تم اضافة القسم بواسطة</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                data-toggle="modal" href="#edit{{ $section->id }}" title="تعديل"><i
                                                    class="las la-pen"></i>
                                            </a>

                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                data-toggle="modal" href="#delete{{ $section->id }}" title="حذف"><i
